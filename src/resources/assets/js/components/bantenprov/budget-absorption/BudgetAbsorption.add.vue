    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/budget-absorption/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/budget-absorption/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/budget-absorption/create'
                  }
                },
                window.location.href = '#/admin/budget-absorption/create')
        ...
        back() {
            window.location = '#/admin/budget-absorption';
        }
    },
    mounted: function() {
        axios.get("/budget-absorption/create").then(response => {
